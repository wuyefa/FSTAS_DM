...
sigma = 1
in_channels = 2048
clip_seg_num_list = [64, 32, 16]
sample_rate_list = [2]
sample_rate = 2
clip_seg_num = 64
sliding_window = clip_seg_num * sample_rate
model_name = "FSTAS_DM_gtea_split" + str(split)
    ...
    train = dict(
        ...
        dynamic_stream_generator=dict(
            ...
            strategy_list = [
                ...
                dict(name = "ListRandomChoiceDynamicStreamGenerator",
                     clip_seg_num_list = [128, 64],
                     sample_rate_list = sample_rate_list),
                dict(name = "ListRandomChoiceDynamicStreamGenerator",
                     clip_seg_num_list = [128, 32, 64],
                     sample_rate_list = sample_rate_list),
            ]
        )
    ),
