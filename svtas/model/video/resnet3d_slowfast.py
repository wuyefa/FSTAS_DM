...
class ResNet3dPathway(ResNet3d):
    ...
    def init_weights(self, pretrained=None, child_model=False, revise_keys=[(r'^module\.', '')]):
        ...
        if child_model is False:
            ...
            super().init_weights(pretrained=pretrained, child_model=child_model, revise_keys=revise_keys)
...
class ResNet3dSlowFast(nn.Module):
    ...
    def _init_weights(self, pretrained=None, revise_keys=[(r'^module\.', '')]):
        ...
        if isinstance(self.pretrained, str):
            ...
            load_checkpoint(self, self.pretrained, strict=True, logger=logger, revise_keys=revise_keys)
