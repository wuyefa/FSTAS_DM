...
class LovaszSoftmaxLoss(BaseLoss):
    def __init__(self, num_classes, classes='present') -> None:
        ...
        self.class_to_sum = list(range(num_classes)) if classes in ['all', 'present'] else classes
...
class LovaszSegmentationLoss(SegmentationLoss):
    def __init__(self,
        ...
        self.sm_loss = LovaszSoftmaxLoss(num_classes, classes=classes)
