...
class LSTMST3DNeck(nn.Module):
    def __init__(self,
        ...
        self.rnn_conv = ConvLSTMResidualLayer(self.seg_in_channel, self.seg_hidden_channel, self.num_classes, self.num_layers, bidirectional=self.bidirectional)
    ...
    def forward(self, x, masks):
        ...
        if self.neck_norm is not None:
            seg_feature = self.neck_norm(seg_feature)
