...
class ListRandomChoiceDynamicStreamGenerator(BaseDynamicStreamGenerator):
    ...
    def __next__(self) -> Dict:
        if self.cur_len < self.max_len:
            ...
            return self.update_cur_len(sample_rate=sample_rate, clip_seg_num=clip_seg_num)
        raise StopIteration
